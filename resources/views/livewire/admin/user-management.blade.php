<section>
    <div class="mx-auto">
        <div class="overflow-hidden bg-whitedark:bg-gray-800 sm:rounded-lg">
                    ...
                    <flux:table :paginate="$this->users">
                        ...
                        <flux:table.rows>
                            @forelse ($this->users as $user)
                                ...
                                <flux:modal name="delete-user-{{ $user->id }}" class="md:w-96">
                                    <div class="space-y-6">
                                        ...
                                        <div class="flex justify-end space-x-3">
                                            <flux:spacer />
                                            <flux:button wire:click="cancelDelete({{ $user->id }})">
                                                {{ __('Cancel') }}
                                            </flux:button>
                                ...
                                <flux:modal name="edit-user-{{ $user->id }}" class="md:w-96" x-on:open="$wire.dispatch('modal-opened', 'edit-user-{{ $user->id }}')">
                                    <div class="space-y-6">
                                        <div>
